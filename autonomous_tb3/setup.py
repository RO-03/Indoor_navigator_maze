...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'maze_solver_route2 = autonomous_tb3.maze_solver_route2:main',
            'maze_solver_route3 = autonomous_tb3.maze_solver_route3:main',
            'amcl_initializer = autonomous_tb3.amcl_initializer:main',
